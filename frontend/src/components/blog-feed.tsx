        ...
        <div className="w-full p-4 sm:w-2/3">
          ...
          <div className="flex flex-col gap-6">
            {loading
              ...
              : posts.length === 0
              ? <div className="text-slate-500 dark:text-dark-tertiary">No posts found. Be the first to create one!</div>
              : posts
                  .slice(0, 5)
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              {loadingLatest
                ...
                ? <div className="text-slate-500 dark:text-dark-tertiary">No latest posts yet.</div>
                : latestPosts
                    .slice(0, 5)
