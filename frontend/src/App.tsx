...
import TripPlanner from './pages/trip-planner.tsx';
import BlogGenerator from './pages/blog-generator.tsx';
import DestinationRecommender from './pages/destination-recommender.tsx';
      ...
      <div className="flex min-h-screen flex-col">
        <Routes>
          <Route path="/">
            ...
            <Route path="destination-recommender" element={<DestinationRecommender />} />
