...
function header() {
  ...
  return (
    <div className="relative -mt-2 h-auto min-h-[460px] bg-[url('./assets/wanderlustbg.webp')] bg-cover bg-fixed bg-center">
      ...
      <div className="absolute inset-0 flex flex-col px-8 py-8 text-slate-50 sm:px-16">
        <div className="flex w-full justify-between">
          <div className="flex cursor-text items-center justify-between gap-2 text-2xl font-semibold">
            ...
            <Link to="/" style={{ textDecoration: 'none' }}>GhumiGumi</Link>
          </div>
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          <Link
            to="/trip-planner"
            className="rounded-full border border-white/60 bg-white/10 px-4 py-1.5 text-sm font-medium text-white backdrop-blur-sm hover:bg-white/20"
          >
            🗺️ AI Trip Planner
          </Link>
          <Link
            to="/destination-recommender"
            className="rounded-full border border-white/60 bg-white/10 px-4 py-1.5 text-sm font-medium text-white backdrop-blur-sm hover:bg-white/20"
          >
            🌍 Destination Finder
          </Link>
